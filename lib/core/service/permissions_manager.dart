...
class PermissionsManager {
  ...
  Future<bool> requestBluetoothPermission() async {
    ...
    await _pref.saveBoolValue(AppConstants.bluetoothStorageKey, true);
    bool isAllGranted = true;
  ...
  Future<bool> requestNotificationPermission() async {
    ...
    // final prefs = await SharedPreferences.getInstance();
    _pref.saveBoolValue(AppConstants.notificationStorageKey, true);
  ...
  Future<bool> requestLocationPermission() async {
    ...
    _pref.saveBoolValue(AppConstants.locationStorageKey, true);
    return status == PermissionStatus.granted;
  }
  ...
  bool get didPreviouslyRequestBluetoothPermission {
    //final prefs = await SharedPreferences.getInstance();
    return _pref.getBool(AppConstants.bluetoothStorageKey) ?? false;
  }

  Future<bool> get didPreviouslyRequestNotificationPermission async {
    // final prefs = await SharedPreferences.getInstance();
    return _pref.getBool(AppConstants.notificationStorageKey) ?? false;
  }

  Future<bool> get didPreviouslyRequestLocationPermission async {
    // final prefs = await SharedPreferences.getInstance();
    return _pref.getBool(AppConstants.locationStorageKey) ?? false;
  }
}
